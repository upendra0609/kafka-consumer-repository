package com.sikku.kafka.orderConsumer;
...
public class OrderConsumer {
	...
	public static void main(String[] args) {
		...
		props.setProperty(ConsumerConfig.FETCH_MIN_BYTES_CONFIG, "102445354");
		props.setProperty(ConsumerConfig.FETCH_MAX_WAIT_MS_CONFIG, "1000");
